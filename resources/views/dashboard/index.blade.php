                ...
                <div class="mt-4 bg-gray-100 p-2">
                    ...
                    @forelse ($job->applicants as $applicant)
                        <div class="py-2">
                            ...
                            <p class="text-grey-800 mt-2">
                                <a href="{{ asset('storage/' . $applicant->resume_path) }}"
                                    class="text-blue-500 hover:underline text-sm" download><i
                            ...
                            <form method="POSt" action="{{ route('applicant.destroy', $applicant->id) }}"
                                ...
                                <button type="submit" class="text-red-500 hover:text-red-700 text-sm"><i
                                        class="fa fa-trash"></i> Delete Applicant</button>
                            </form>
                        </div>
                    @empty
                        <p class="text-grey-700 mb-5">No applicants for this job</p>
                    @endforelse
                </div>
            @empty
