            ...
            <div class="container mx-auto p-4">
                ...
                @auth
                    ...
                    <div x-data="{ open: false }" id="applicant-form">
                        ...
                        @if ($existingApplication)
                            <a href="{{ route('withdraw_application', $application->id) }}">
                                <button
                                    class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-black bg-red-400  hover:bg-red-500"
                        ...
                        <div x-cloak x-show="open"
                            ...
                            <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                                ...
                                <form method="POST" action="{{ route('applicant.store', $job->id) }}"
                                    ...
                                    <x-inputs.file class="file" id="resume" name="resume"
                                        label="Upload Your Resume (.pdf)" :required="true" />
                                    ...
                                    <button @click="open = false"
                                        class="bg-gray-300 hover:bg-gray-400 text-black py-2 px-4 rounded-md">
                                        cancel
                                    </button>
                ...
                @else
                    <p class="my-5 bg-gray-200 rounded-lg p-3">
                        <i class="fa fa-info-circle mr-3"></i> You must be logged in to apply for this a job
                    </p>
                @endauth
